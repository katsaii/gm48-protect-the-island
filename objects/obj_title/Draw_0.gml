...
draw_text_3d(cam_xcentre, cam_top + 105, "Protect the Island", 5, secondary, CYellow.REKINDLED);
draw_set_font(fnt_script);
draw_text_3d(cam_xcentre, cam_top + 80, "Witch Wanda", 10, make_color_rgb(86, 36, 92), make_color_rgb(203, 127, 212));
draw_set_font(fnt_tiny);
draw_set_colour(primary);
